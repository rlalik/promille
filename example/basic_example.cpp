...
auto main(int argc, char* argv[]) -> int
{
    ...
    mille.add_plane(1, 11, 12, 13)
        .set_globals_configuration(promille::Kind::FREE, promille::Kind::FREE, promille::Kind::FIXED)
    ...
    std::array<promille::Kind, 3> plane_3_global_kinds = {promille::Kind::FREE, promille::Kind::FREE, promille::Kind::FIXED};
