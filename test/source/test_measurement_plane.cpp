...
TEST(PlaneAndModels, MeasurementPlane)
{
    ...
    auto plane1 = promille::measurement_plane<the_type, promille_tests::dummy_residual_model<the_type, the_type>>(nullptr, gp1, gp2, gp3);
...
TEST(PlaneAndModels, ModelPlanes)
{
    ...
    auto model_plane1 = promille::model_planes<the_type, promille_tests::dummy_residual_model<the_type, the_type>>(nullptr);
